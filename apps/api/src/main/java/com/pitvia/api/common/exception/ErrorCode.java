...
public enum ErrorCode {
    ...
    /**
     * 指定された整備履歴が存在しない、またはログインユーザーに閲覧権限がない（404）
     */
    MAINTENANCE_RECORD_NOT_FOUND("指定された整備履歴が見つかりません"),

    /**
     * 整備履歴は閲覧できるが、編集・削除の権限が無い（403）
     *
     * <p>
     * 車両所有者かどうかではなく、その整備履歴を登録したユーザー本人かどうかで判定する。
     * </p>
     */
    MAINTENANCE_RECORD_EDIT_NOT_ALLOWED("この整備履歴を編集する権限がありません"),

    /**
     * 更新リクエストで指定された作業項目IDが、対象の整備履歴に存在しない
     */
    MAINTENANCE_WORK_ITEM_NOT_FOUND("指定された作業項目が見つかりません"),

    /**
     * 更新リクエストで指定された部品IDが、対象の作業項目に存在しない
     */
    MAINTENANCE_PART_NOT_FOUND("指定された部品が見つかりません"),

    /**
     * 指定された招待コードが無効（存在しない・期限切れ・失効済みのいずれかであり、区別しない）
     */
    INVALID_INVITE_CODE("指定された招待コードは無効です"),
